#works
PowerShell.exe -ExecutionPolicy Bypass $ScriptFromGithHub = Invoke-WebRequest https://raw.githubusercontent.com/tomarbuthnot/Run-PowerShell-Directly-From-GitHub/master/Run-FromGitHub-SamplePowerShell.ps1
PowerShell.exe -ExecutionPolicy Bypass Invoke-Expression $($ScriptFromGithHub.Content)
